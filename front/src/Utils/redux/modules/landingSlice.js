        ...
        helpBlocks: [
            {
                ...
                body: [
                    'Подобрать для клиента базу из целевой аудитории, подготовить креативы и сделать массовую\n' +
                    'рассылку всем потенциальным клиентам/подписчикам. Твой клиент наверняка возбудиться\n' +
                    'от притока новых клиентов и возможно даже уводит своего маркетолога, так что будь аккуратней с\n' +
                    'нашим оружием.😃',
                    ...
                    'и последующей продажи. Именно при таком подходе мы наблюдаем наивысшие показатели конверсий. Людям не нравится спам, а с Айпост вы сможете очень деликатно вести продажи. '
            ...
            },
            {
                ...
                body: [
                    ...
                    'как важно на начальных этапах получать обратную связь людей по своему контенту, в виде лайков,\n' +
                    ...
                    'IpostX сделает так, чтобы тебя замечали настоящие, живые люди, которые будут принимать решение\n' +
            ...
            },
            {
                ...
                body: [
                    ...
                    'Познакомите со своим продуктом/услугой людей, которые бы никогда не узнали про ваше предложение без IpostX'
                ],
                active: false,
            }
        ]
